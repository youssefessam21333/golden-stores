    ...
    <Layout title={product.name} description={product.description}>
      ...
      <Grid container spacing={1}>
        <Grid item md={6} xs={12}>
          <Image src={product.image} alt={product.name} title={product.name} width={640} height={640} layout='responsive'></Image>
        </Grid>
        <Grid item md={3} xs={12}>
          <List>
            ...
            <ListItem><Typography>Raring: {product.rating} starts ({product.numReviews} reviews)</Typography></ListItem>
